...
def checkSampleFormat(sampleFormat):
    ...
    # sampleFormat = bpy.context.preferences.system.audio_sample_format
    if (sampleFormat == "S16"):
...
def register():
    ...
    # Add menu entry
    bpy.types.TOPBAR_MT_file_export.append(menuEntry)
...
def unregister():
    ...
    # Remove menu entry
    bpy.types.TOPBAR_MT_file_export.remove(menuEntry)
